...
{
  public ICourseService GetCourseService1()
  {
  ...
  public async Task<IActionResult> GetEnrollments(
      int courseId, ICourseService courseService1, CancellationToken ct)
  {
    var course = await courseService1.GetByIdAsync(courseId, ct);
